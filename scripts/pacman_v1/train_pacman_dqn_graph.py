...
from graphrl.environments.pacman.pacman_gym_v1 import make_pacman_env, make_pacman_knowledge_graph
...
ex = sacred.Experiment('train_pacman_dqn_graph')
maybe_add_slack(ex)
...
def build_envs(layout_folder, ghost_type, render=False,
               dont_crop_adj=False, no_kg_edges=False, fully_connected_kg=False, fully_connected_distinct_kg=False, same_edge_feats_kg=False,
               should_load_kg=False, load_kg_file=None, should_save_kg=False, save_kg_file=None):
    ...
    kg_entities, KG, num_node_feats, num_edge_feats = make_pacman_knowledge_graph(ghost_type=ghost_type,
